...
| H1 | poids économique des 79 plateformes à SIREN depuis les comptes déposés, par lots de dix (règle 16) | **priorité 1 — à lancer** |
| H2 | recensement des groupes portant plusieurs immatriculations sur les 163 entrées (règle 21), pour établir le nombre réel d'acteurs | **priorité 2 — passe unique** |
