            ...
            <ul class="nav-links">
                ...
                <li class="nav-dropdown">
                    ...
                    <ul class="nav-submenu">
                        ...
                        <li><a href="./validation.html">✅ Les 4 niveaux de contrôle</a></li>
                ...
                <li class="nav-dropdown">
                    ...
                    <ul class="nav-submenu">
                        ...
                        <li><a href="./methodologie-plateformes.html">🔍 Méthodologie du référentiel PA</a></li>
                    </ul>
                </li>
                <li class="nav-dropdown">
